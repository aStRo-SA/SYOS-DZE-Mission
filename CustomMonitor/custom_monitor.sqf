...
fnc_debug = {
    ...
    while {debugMonitor} do
    {
        ...
        <t size='1.0' font='Bitstream' align='left' color='#B5DAFF' >Restart every 3 Hours </t><t size='1.0' font='Bitstream' align='right' color='#B5DAFF' >%17 m</t><br/><br/>
		<t size='0.9'font='Bitstream'align='left' color='#298DEF' >ts: 197.242.148.180:9987
		</t><br/>
